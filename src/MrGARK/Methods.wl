...
Selectable->False]\)}}
	...
	<|"Names" -> {"EX3-EX3 3(2)S"}, "Method" -> MrGark[
		RungeKuttaCatalog["3 Stage Explicit, Order 3"]/.Subscript[\[FormalC], 3]->1,
		{{\!\(\*
TagBox[GridBox[{
{"\[Piecewise]", GridBox[{
{
